...
def get_countries(directory):
    '''
        get_countries: gets the files directory of the data, and creates a list of 
                       of all the countries alpha-3 codes embedded in the file name
...
def temperature_analysis():
    ...
    country_codes, country_names = get_countries('../Data/data/temp/')
    temp_df = merge_data('../Data/data/temp/tas_timeseries_annual_cru_1901-2021_', country_codes, country_names,year_labels)

    co2_df = format_co2_data('../Data/data/co2/co2_data.csv')
